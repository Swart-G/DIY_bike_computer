...
// 30x30, MSB-first monochrome raster of the user-provided 24x24 SVG path.
// Keeping it as a transparent mask lets the same exact contour inherit the
// correct foreground colour on every surface.
const uint8_t kSettingsGearBitmap[] PROGMEM = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x80, 0x00,
    0x00, 0x0F, 0xC0, 0x00, 0x00, 0x0F, 0xC0, 0x00, 0x00, 0x1F, 0xE0, 0x00,
    0x00, 0x3F, 0xF0, 0x00, 0x07, 0xFF, 0xFF, 0x80, 0x0F, 0xFF, 0xFF, 0xC0,
    0x0F, 0xFF, 0xFF, 0xC0, 0x1F, 0xF8, 0x7F, 0xE0, 0x1F, 0xE0, 0x1F, 0xE0,
    0x0F, 0xE0, 0x1F, 0xC0, 0x07, 0xC0, 0x0F, 0x80, 0x07, 0xC0, 0x0F, 0x80,
    0x07, 0xC0, 0x0F, 0x80, 0x07, 0xC0, 0x0F, 0x80, 0x0F, 0xE0, 0x1F, 0xC0,
    0x1F, 0xE0, 0x1F, 0xE0, 0x1F, 0xF8, 0x7F, 0xE0, 0x0F, 0xFF, 0xFF, 0xC0,
    0x0F, 0xFF, 0xFF, 0xC0, 0x07, 0xFF, 0xFF, 0x80, 0x00, 0x3F, 0xF0, 0x00,
    0x00, 0x1F, 0xE0, 0x00, 0x00, 0x0F, 0xC0, 0x00, 0x00, 0x0F, 0xC0, 0x00,
...
void IconRenderer::draw(TFT_eSPI& tft, Icon icon, int16_t cx, int16_t cy, uint16_t color,
  ...
  switch (icon) {
    ...
    case Icon::Phone:
      ...
      break;
    case Icon::Settings: {
      tft.drawBitmap(cx - 15, cy - 15, kSettingsGearBitmap, 30, 30, color);
      break;
    }
    case Icon::Display:
