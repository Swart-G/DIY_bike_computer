# Android companion APK 2.1.1

`DIY-Bike-Computer-2.1.1-release.apk` is the production release build:

- package: `com.diybikecomputer.companion`;
- version: `2.1.1` (`versionCode 2`);
...
apksigner verify --verbose --print-certs \
  --v4-signature-file DIY-Bike-Computer-2.1.1-release.apk.idsig \
  DIY-Bike-Computer-2.1.1-release.apk
keytool -printcert -file diy-bike-computer-release-cert.pem
adb install -r DIY-Bike-Computer-2.1.1-release.apk
```
...
release can be installed. Future 2.1.1+ release builds signed by this same key can update
